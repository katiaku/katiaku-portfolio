            ...
            <div className="lg:flex lg:justify-between gap-6">
                ...
                >
                    <Image
                        ...
                        width={100}
                        height={100}
                        alt={t('frontend_dev_illustration')}
                    />
                    <h4 className="tech-group-title uppercase">
                        {t('tools_frontend')}
                    </h4>
                ...
                >
                    <Image
                        ...
                        width={100}
                        height={100}
                        alt={t('backend_dev_illustration')}
                    />
                    <h4 className="tech-group-title uppercase">
                        {t('tools_backend')}
                    </h4>
                    <div className="flex flex-col md:flex-row lg:flex-col md:flex-wrap gap-3 md:gap-y-2 md:justify-center md:gap-8 lg:gap-2 pb-2">
                        ...
                        <div className="tech-subj">
                            ...
                            <p className="tech-item">Express.js</p>
                        </div>
                        <div className="tech-subj">
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row lg:flex-col md:flex-wrap gap-3 md:gap-y-2 md:justify-center md:gap-8 lg:gap-2 pb-2">
                        <div className="tech-subj">
                            <SiJest className="text-x" />
                            <p className="tech-item">Jest</p>
                        </div>
                        <div className="tech-subj">
                            <SiCypress className="text-x" />
                            <p className="tech-item">Cypress</p>
                        </div>
                        <div className="tech-subj">
                            <SiPostman className="text-x" />
                        ...
                        <div className="tech-subj">
                            <FaGithub className="text-x" />
                            <p className="tech-item">GitHub</p>
                        </div>
                        <div className="tech-subj">
                            <FaGitlab className="text-x" />
                            <p className="tech-item">GitLab</p>
                        </div>
                        <div className="tech-subj">
                            <SiStorybook className="text-x" />
                            <p className="tech-item">Storybook</p>
                        </div>
                        <div className="tech-subj">
                            <FaFigma className="text-x" />
                            <p className="tech-item">Figma</p>
                        </div>
                        <div className="tech-subj">
                            <FaJira className="text-x" />
