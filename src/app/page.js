    ...
    <div className={darkMode ? "dark" : ""}>
      ...
      <main className='bg-white px-10 pb-20 md:px-20 lg:px-40 dark:bg-gray-900'>
        ...
        <footer className='my-2 flex justify-center'>
          <a className="bg-gradient-to-r from-purple-600 to-blue-500 text-white px-4 py-2 leading-8 rounded-md hover:ring-4 hover:ring-indigo-300" href="#">Back To Top</a>
        </footer>
      </main>
    </div>
  )
